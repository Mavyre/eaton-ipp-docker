...
ENV INSTALLER_URL=https://www.eaton.com/content/dam/eaton/products/backup-power-ups-surge-it-power-distribution/power-management-software-connectivity/eaton-intelligent-power-protector/software/ippv1-75/ipp-linux_1.75.183-1_amd64.deb

# Labels
LABEL org.label-schema.schema-version="1.0"
LABEL org.label-schema.name="Mavyre/eaton-ipp"
LABEL org.label-schema.description="Eaton IPP container"
LABEL org.label-schema.version=1.75.183-1
